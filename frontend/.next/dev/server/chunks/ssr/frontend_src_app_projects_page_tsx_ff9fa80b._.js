...
function ProjectsListPage() {
    ...
    async function addProject(e) {
        ...
        try {
            const p = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProject"])(name.trim(), desc.trim());
            setProjects((s)=>[
                    ...s,
                    p
                ]);
